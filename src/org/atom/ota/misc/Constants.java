...
public final class Constants {
    ...
    public static final String PROP_BUILD_DATE = "org.atom.build_date_utc";
    ...
    static final String PROP_DEVICE = "org.atom.device";
    static final String PROP_BUILD_VERSION = "org.atom.version.prop";
    static final String PROP_VERSION_CODE = "org.atom.ota.version_code";
    static final String OTA_URL = "https://raw.githubusercontent.com/AtomOrganization/official_devices/master/builds/%s.json";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/AtomOrganization/official_devices/master/changelogs/%s/%s.txt";
    public static final String DOWNLOAD_PATH = "/data/system_updates/";
    static final String EXPORT_PATH = "Atom-Updates/";
